...
(* $Id: buffer2.ml,v 1.18 2005/10/25 18:34:07 doligez Exp $ *)
...
let resize b more =
  ...
  if !new_len > Sys.max_string_length then begin
    ...
    else failwith "Buffer2.add: cannot grow buffer"
  end;
...
(* This is mine! *)
(* Bleh. I don't like writing in this style *)
let remove_first b len =
	if len > b.position
	then invalid_arg "Buffer2.remove_first"
	else begin
		String.blit b.buffer len b.buffer 0 (b.position - len);
		b.position <- b.position - len
	end

let remove_last b len =
	if len > b.position
	then invalid_arg "Buffer2.remove_last"
...
let add_substring b s offset len =
  ...
  then invalid_arg "Buffer2.add_substring";
